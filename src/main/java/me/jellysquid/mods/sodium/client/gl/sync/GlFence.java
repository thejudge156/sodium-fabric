...
public class GlFence {
    ...
    public boolean isCompleted() {
        ...
        try (MemoryStack stack = MemoryStack.stackPush()) {
            ...
            result = GLES32.glGetSynci(this.id, GLES32.GL_SYNC_STATUS, count);
        ...
        return result == GLES32.GL_SIGNALED;
    }
    ...
    public void sync(long timeout) {
        this.checkDisposed();
        GLES32.glWaitSync(this.id, GLES32.GL_SYNC_FLUSH_COMMANDS_BIT, timeout);
    }

    public void delete() {
        GLES32.glDeleteSync(this.id);
        this.disposed = true;
    }
